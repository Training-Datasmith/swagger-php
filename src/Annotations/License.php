 ...
 * @Annotation
 */
class License extends Abstract_Annotation
{
    /**
     ...
     * @inheritdoc
     */
    public static $_types = ['name' => 'string', 'identifier' => 'string', 'url' => 'string'];
    /**
     * @inheritdoc
     */
    ...
    public function validate(?Analysis $analysis = null, string $version = Open_Api::DEFAULT_VERSION, ?object $context = null): bool
    {
        ...
        if (!Open_Api::version_match($version, '3.0.x')) {
            if (!Generator::is_default($this->url) && !Generator::is_default($this->identifier)) {
